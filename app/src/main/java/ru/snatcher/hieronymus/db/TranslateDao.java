...
public class TranslateDao extends AbstractDao<Translate, String> {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"TRANSLATE\" (" + //
                "\"LANG\" TEXT," + // 0: Lang
                "\"TRANSLATED_TEXT\" TEXT PRIMARY KEY NOT NULL UNIQUE ," + // 1: TranslatedText
    ...
    public Translate readEntity(Cursor cursor, int offset) {
        Translate entity = new Translate( //
            cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0), // Lang
    ...
    public void readEntity(Cursor cursor, Translate entity, int offset) {
        entity.setLang(cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0));
